...
@RequestScoped
@Named
public class CatalogoAdministradoContactoControlador extends PaginacionControlador<TablaModelo> {
    ...
    public void init() {
        ...
        for (int i=0; i < 33; i++) {
            ((ArrayList<TablaModelo>) collection).add(new TablaModelo("Contacto" + i, i));
        }
