package tecolotl.web.administrador.modelo;

public class TablaNoValido {
    ...
    public TablaNoValido() {
    }

    public TablaNoValido(String nick, String nombre, String apellidosm, String apellidosp, String cooreo, String contraseña, Integer id) {
        this.nick = nick;
        this.nombre = nombre;
